...
@section('content')
    ...
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">Proje Düzenle</h6>
        </div>
        <!-- /.page-title-left -->
        <div class="page-title-right d-none d-sm-inline-flex">
            ...
            <div class="d-none d-md-inline-flex justify-center align-items-center"><a href="javascript: void(0);" class="btn btn-color-scheme btn-sm fs-11 fw-400 mr-l-40 pd-lr-10 mr-l-0-rtl mr-r-40-rtl hidden-xs hidden-sm ripple" target="_blank">Proje Düzenle</a>
            </div>
        </div>
        <!-- /.page-title-right -->
    </div>
    ...
    <div class="widget-list">
        <form action="{{ route('home.work.update', ['id'=>$data[0]['id']]) }}" enctype="multipart/form-data" method="post">
            @csrf
            <div class="row">
                <!-- /.col-md-12 -->
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="subject" id="" cols="30" rows="3" class="form-control">{{ $data[0]['subject'] }}</textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="l30">Proje Desciption</label>
                        <textarea name="description" id="" cols="30" rows="3" class="form-control">{{ $data[0]['description'] }}</textarea>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" value="{{ $data[0]['url'] }}" name="url" class="form-control" >
                </div>
                <div class="col-md-12">
