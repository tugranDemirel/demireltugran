...
<!-- Mirrored from rainbowit.net/html/inbio/index-technician.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Dec 2021 15:09:13 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Tuğran Demirel</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('front/assets/images/favicon.html') }}">
    <!-- CSS
    ============================================ -->
                ...
                <div class="col-lg-6">
                    <div class="header-right">
                        <ul class="rn-header-content">
                            <li><span class="overhead">EMAİL</span>example@gmail.com</li>
                            <li><span class="overhead">TELEFON NUMARASI</span>+880123456789</li>
                        </ul>
                    ...
                    <div class="d-flex flex-wrap align-content-start h-100 w-100">
                        <div class="position-sticky content-wrapper sticky-top rbt-sticky-top-adjust-three w-100">
                            <ul class="nav tab-navigation-button tab-smlg flex-column nav-pills me-3" id="v-pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link rn-nav" id="v-pills-settings-tabs" data-toggle="tab" href="#v-pills-settings" role="tab" aria-selected="true">Bloglar</a>
                                </li>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="image-area shadow-none padding-none" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" data-aos-once="true">
                                                        <div class="thumbnail">
                                                            <img src="{{ asset('front/assets/images/about/about-2.jpg')}}" alt="Personal Portfolio Image">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt--50">
                                                ...
                                                <div class="rn-brand-area">
                                                    <div class="container">
                                                        <div class="row mb--30">
                                                            <div class="col-12 text-center">
                                                                <h6 class="title color-lightn m--0">Referanslar</h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="brand-wrapper-three mb_dec--30">
                                                                ...
                                                                <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true" class="rn-brand flex-basis-style-1">
                                                                    <div class="border-style shadow-none inner smlg-brand text-center">
                                                                        <div class="thumbnail">
                                                                            <a href="#"><img src="{{ asset('front/assets/images/client/png/client1.html') }}" alt="Client-image"></a>
                                                                        </div>
                                                        ...
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{ asset('front/assets/images/portfolio/portfolio-01.html') }}" alt="Personal Portfolio Images">
                                                                </a>
                                                            </div>
                                                            <div class="content">
                                                ...
                                                <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--30 mt_md--30 mt_sm--30">
                                                    <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{ asset('front/assets/images/portfolio/portfolio-02.html') }}" alt="Personal Portfolio Images">
                                                                </a>
                                                            </div>
                                                            <div class="content">
                                                                <div class="category-info">
                                                ...
                                                <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--30 mt_md--30 mt_sm--30">
                                                    <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{ asset('front/assets/images/portfolio/portfolio-03.html') }}" alt="Personal Portfolio Images">
                                                                </a>
                                                            </div>
                                                            <div class="content">
                                                                <div class="category-info">
                                                ...
                                                <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--30 mt_md--30 mt_sm--30">
                                                    <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{ asset('front/assets/images/portfolio/portfolio-04.html') }}" alt="Personal Portfolio Images">
                                                                </a>
                                                            </div>
                                                            <div class="content">
                                                                <div class="category-info">
                                                ...
                                                <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--30 mt_md--30 mt_sm--30">
                                                    <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{ asset('front/assets/images/portfolio/portfolio-05.html') }}" alt="Personal Portfolio Images">
                                                                </a>
                                                            </div>
                                                            <div class="content">
                                                                <div class="category-info">
                                                ...
                                                <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="col-lg-6 col-xl-4 col-md-6 col-12 mt--30 mt_md--30 mt_sm--30">
                                                    <div class="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{ asset('front/assets/images/portfolio/portfolio-06.html') }}" alt="Personal Portfolio Images">
                                                                </a>
                                                            </div>
                                                            <div class="content">
                                                                <div class="category-info">
                                                ...
                                                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="400" data-aos-once="true" class="col-lg-6 col-xl-4 mt--30 col-md-6 col-sm-12 col-12 mt--30">
                                                    <div class="rn-blog" data-toggle="modal" data-target="#exampleModalCenters">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{ asset('front/assets/images/blog/blog-01.html') }}" alt="Personal Portfolio Images">
                                                                </a>
                                                            </div>
                                                            <div class="content">
                                                                <div class="category-info">
                                                ...
                                                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="600" data-aos-once="true" class="col-lg-6 col-xl-4 mt--30 col-md-6 col-sm-12 col-12 mt--30">
                                                    <div class="rn-blog" data-toggle="modal" data-target="#exampleModalCenters">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{ asset('front/assets/images/blog/blog-02.html') }}" alt="Personal Portfolio Images">
                                                                </a>
                                                            </div>
                                                            <div class="content">
                                                                <div class="category-info">
                                                ...
                                                <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="800" data-aos-once="true" class="col-lg-6 col-xl-4 mt--30 col-md-6 col-sm-12 col-12 mt--30">
                                                    <div class="rn-blog" data-toggle="modal" data-target="#exampleModalCenters">
                                                        <div class="inner">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0)">
                                                                    <img src="{{ asset('front/assets/images/blog/blog-03.html') }}" alt="Personal Portfolio Images">
                                                                </a>
                                                            </div>
                                                            <div class="content">
                                                                <div class="category-info">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="contact-about-area">
                                                        <div class="thumbnail">
                                                            <img src="{{ asset('front/assets/images/contact/contact1.html') }}" alt="contact-img">
                                                        </div>
                                                            ...
                                                            <form class="rnt-contact-form rwt-dynamic-form row" id="contact-form" method="POST" action="">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="contact-name">ADINIZ</label>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="contact-phone">TELEFON NUMARASI</label>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        <label for="contact-email">EMAİL ADRESİNİZ</label>
                                                                        <input class="form-control form-control-sm" id="contact-email" required name="email" type="email">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        <label for="contact-message">MESAJINIZ</label>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-area text-center">
                    ...
                    <div class="logo">
                        <a href="index-2.html">
                            <img src="{{ asset('front/assets/images/logo/logo-vertical.html') }}" alt="logo">
                        </a>
                    </div>

                    <p class="description mt--30">© 2022 - {{ date('Y') }}. Tüm hakları <a target="_blank" href="">Tuğran Demirel</a> tarafından saklıdır.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="portfolio-popup-thumbnail">
                            <div class="image">
                                <img class="w-100" src="{{ asset('front/assets/images/portfolio/portfolio-04.html')  }}" alt="slide">
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="exampleModalCenters" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-news" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="{{ asset('front/assets/images/blog/blog-big-01.html') }}" alt="news modal" class="img-fluid modal-feat-img">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="single-demo">
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="index-2.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/main-demo.html') }}" alt="Personal Portfolio">
                                        ...
                                        <div class="inner">
                                            <h3 class="title"><a href="index-2.html">Main Demo</a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="inner badge-2">
                                        <div class="thumbnail">
                                            <a href="index-technician.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/index-technician.png') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner badge-2">
                                        <div class="thumbnail">
                                            <a href="index-model.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-model-v2.png') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner badge-1">
                                        <div class="thumbnail">
                                            <a href="home-consulting.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-consulting.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner badge-1">
                                        <div class="thumbnail">
                                            <a href="fashion-designer.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/fashion-designer.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="index-developer.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/developer.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="instructor-fitness.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/instructor-fitness.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner badge-1">
                                        <div class="thumbnail">
                                            <a href="home-web-Developer.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-model.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-designer.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-video.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-content-writer.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/text-rotet.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-instructor.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/index-boxed.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-freelancer.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-sticky.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-photographer.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/index-bg-image.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="index-politician.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/front-end.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="single-demo coming-soon">
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="#">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/coming-soon.html') }}" alt="Personal Portfolio">
                                            </a>
                                        </div>
                                        <div class="inner">
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="index-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/main-demo-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner badge-2">
                                        <div class="thumbnail">
                                            <a href="index-technician-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/index-technician-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner badge-2">
                                        <div class="thumbnail">
                                            <a href="index-model-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-model-v2-white.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner badge-1">
                                        <div class="thumbnail">
                                            <a href="home-consulting-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-consulting-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner badge-1">
                                        <div class="thumbnail">
                                            <a href="fashion-designer-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/fashion-designer-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="index-developer-white-version.html">
                                                <img class="w-100" src="assets/images/demo/dev{{ asset('front/eloper-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="instructor-fitness-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/instructor-fitness-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner badge-1">
                                        <div class="thumbnail">
                                            <a href="home-web-developer-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-model-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-designer-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-video-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-content-writer-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/text-rotet-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-instructor-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/index-boxed-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-freelancer-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/home-sticky-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="home-photographer-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/index-bg-image-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
                                    ...
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="index-politician-white-version.html">
                                                <img class="w-100" src="{{ asset('front/assets/images/demo/front-end-white-version.html') }}" alt="Personal Portfolio">
                                                <span class="overlay-content">
                                                    <span class="overlay-text">View Demo <i
                                                            class="feather-external-link"></i></span>
                                                    </span>
...
<!-- Mirrored from rainbowit.net/html/inbio/index-technician.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Dec 2021 15:09:15 GMT -->
</html>
